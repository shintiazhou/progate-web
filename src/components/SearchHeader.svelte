...
>
  <div class="flex gap-4">
    <a href="/">
      <img class="rounded-full cursor-pointer" src={icon} alt="progate" /></a
    >
    ...
    >
      <input
        class="py-2 px-3 w-full rounded-full outline-none text-sm font-medium bg-white text-gray-900"
        type="search"
        name="search"
        placeholder="Search"
      />
